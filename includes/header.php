...
<head>
  ...
  <title><?php echo $title; ?>The Cliffs Tracker</title>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link<?php if ($page == 'today') { echo ' active'; } ?>" aria-current="page" href="/">Today</a>
          </li>
          <li class="nav-item">
            <a class="nav-link<?php if ($page == 'browse') { echo ' active'; } ?>" aria-current="page" href="/browse">Browse</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item<?php if ($page == 'average' && $weekday == 0) { echo ' active'; } ?>" href="/average/0">Sunday</a></li>
              <li><a class="dropdown-item<?php if ($page == 'average' && $weekday == 1) { echo ' active'; } ?>" href="/average/1">Monday</a></li>
              <li><a class="dropdown-item<?php if ($page == 'average' && $weekday == 2) { echo ' active'; } ?>" href="/average/2">Tuesday</a></li>
              <li><a class="dropdown-item<?php if ($page == 'average' && $weekday == 3) { echo ' active'; } ?>" href="/average/3">Wednesday</a></li>
              <li><a class="dropdown-item<?php if ($page == 'average' && $weekday == 4) { echo ' active'; } ?>" href="/average/4">Thursday</a></li>
              <li><a class="dropdown-item<?php if ($page == 'average' && $weekday == 5) { echo ' active'; } ?>" href="/average/5">Friday</a></li>
              <li><a class="dropdown-item<?php if ($page == 'average' && $weekday == 6) { echo ' active'; } ?>" href="/average/6">Saturday</a></li>
            </ul>
          </li>
          <li class="nav-item">
